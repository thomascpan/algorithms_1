...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        if (Double.compare(y1, y0) == 0 && Double.compare(x1, x0) == 0) {
            return Double.NEGATIVE_INFINITY;
        } else if (Double.compare(x1, x0) == 0) {
    ...
    private class BySlopeOrder implements Comparator<Point> {
        ...
        public int compare(Point a, Point b) {
            int result;
            double aSlope = a.slopeTo(this.point);
            double bSlope = b.slopeTo(this.point);

            result = Double.compare(aSlope, bSlope);
